...
import { Loader2, AlertTriangle, Download, FileText, Activity, BarChart, FileWarning, CheckCircle, Info, TrendingUp, ShieldAlert, ListChecks, FileHeart, Beaker, Stethoscope, Leaf, EyeOff } from 'lucide-react';
                ...
                <AccordionContent className="pt-2">
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                       ...
                       <p className="text-sm text-blue-700">{analysisResult.specialist_recommendation}</p>
                    </div>
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {!imageData && (
              <p className="text-center text-sm text-yellow-600">Please capture an eye scan image to enable analysis.</p>
            )}
          </form>
        </Form>
      </CardContent>
